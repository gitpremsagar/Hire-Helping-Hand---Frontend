                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              >
                                ...
                                <span className="text-xs text-gray-500 text-center">Offer services</span>
                              </label>
                            </div>
                          </FormControl>
                        </FormItem>
                          ...
                          <FormControl>
                            <div className="relative">
                              <input
                                ...
                                onChange={() => {
                                  field.onChange(true);
                                  form.setValue("isFreelancer", false);
                                }}
                                className="sr-only"
                                disabled={isLoading}
                              />
                              ...
                              >
                                ...
                                <span className="text-xs text-gray-500 text-center">Hire services</span>
                              </label>
                            </div>
                          </FormControl>
                        </FormItem>
